...
public class DoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Data.getIsAdmin().equals("0")){
            ...
            listUsersButton.setVisibility(View.GONE);
        }
        ...
        params2.setMargins(150, 10, 150, 30);
                                        ...
                                        assignTaskButton.setOnClickListener(new Button.OnClickListener() {
                                            ...
                                            public void onClick(View view) {
                                                ...
                                                for (int j = 0; j < Data.getAllUsers().size(); j++) {
                                                    ...
                                                    if(Data.getAllUsers().get(j).getAdmin() == 1){
                                                        button2.setBackgroundColor(argb(200,153, 255, 102));
                                                        button2.setText(Data.getAllUsers().get(j).getUserName()+" (Admin)");
                                                    }
                                                    else {
    ...
    public void addTask(View view){
        ...
        TextView timeHint = new TextView(DoActivity.this);
        timeHint.setText("time to complete (optional)");
        timeHint.setLayoutParams(params);
        timeHint.setTextColor(argb(200,179, 71, 0));

        timeHint.setTextAlignment(View.TEXT_ALIGNMENT_CENTER);
    ...
    public void addUser(View view){
        ...
        adminCheckBox.setHintTextColor(argb(200,179, 71, 0));
        adminCheckBox.setTranslationX(30);
        adminCheckBox.setTranslationY(-8);
